...
Nexus is accompanied by a web application that allows the end-user to compose new smart contracts in Nexus, as well as to manage and evaluate pending contracts. A demo of the web application can be found at https://youtu.be/G81QVTxj7Qk.
